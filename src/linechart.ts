...
export class AppendingLineChart {
  ...
  constructor(
    container: d3.Selection<HTMLElement, unknown, any, any>,
    lineColors: string[]
  ) {
    ...
    this.svg = (container.append("svg") as d3.Selection<SVGSVGElement, unknown, any, any>)
  ...
  private redraw() {
    ...
    // d3 v7: d3.line() replaces d3.svg.line()
    ...
    for (let i = 0; i < this.numLines; i++) {
      this.paths[i].datum(this.data).attr("d", getLine(i) as any);
    }
  }
}